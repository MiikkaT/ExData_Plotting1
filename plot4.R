## PLOT 4
## This script constructs the plot 4 and saves it to a PNG file in a
## working directory. First (if-else structure), it checks whether
...
plot(DateTime,data$Voltage,type="l",xlab="datetime",
     ylab="Voltage")
plot(DateTime,data$Sub_metering_1,type="n",xlab="",
